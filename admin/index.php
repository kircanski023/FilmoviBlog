...
?>
	...
	<body>
				...
				' . $msg . '
				  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
					<span aria-hidden="true">&times;</span>
						...
						<h1>Vaš nalog</h1>
						<form method="post">
							Ime:<input name="author_name" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Unesite ime" value="<?php echo $_SESSION['author_name']; ?>"><br>
							Email:
							<input name="author_email" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Unesite email" value="<?php echo $_SESSION['author_email']; ?>"><br>
							Lozinka:
							<input name="author_password" type="password" class="form-control" id="exampleInputPassword1" placeholder="Lozinka"><br>
							Vaša biografija:
		...
		<div style=" "><?php include_once "footer.php"; ?></div>
...
<?php
	...
	header("Location: login.php?message=Prijavite+se");
}
?>