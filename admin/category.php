        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
			...
			?>
				...
				<button id="addCatBtn" class="btn btn-info">Dodaj novu</button>
				<hr>
				<div style="display:none;" id="addCatForm">
					<form action="addcat.php" method="post">
						<input type="text" name="category_name" class="form-control" placeholder="Ime kategorije"><br>
						<button name="submit" class="btn btn-success">Dodaj kategoriju</button>
					</form><br>
				</div>
